...
def fr_veg_count ( a: int, b: int )-> str:
    """
...
# Using try-except for handling possible KeyboardInterrupt and ValueError exception from user
try:
    ...
    total_count: str= fr_veg_count(fruit_count, vegetable_count)
